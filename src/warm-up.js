...
function determineIfCanReadQuickly() {
  if(pages < 1000) {
...
var books = ['Educated', 'The Kite Runner', 'Good Omens', 'Becoming', 'The Song of Achilles'];
...
var belowTwoHundred = [1, 5, 7, 11, 57, 33, 9, 13, 71, 77, 65, 51]
